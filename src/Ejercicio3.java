...
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		...
		while (opcion != 4) {
			...
			Pantalla.escribirString("Pulse 1 para Añadir un producto, 2 para Eliminar un producto, 3 para mostrar el total de productos, 4 para abandonar el programa");
			Pantalla.escribirSaltoLinea();
			opcion = Libreria.leerEntre(1, 4, "Seleccione su opción de la 1 a la 4");
